// entrypoints/contentScript.content.ts
import { defineContentScript } from '#imports';
import { PasteMessage, PasteResponse, MESSAGE_TYPES } from "../src/core/types/messaging";
import { INPUT_SELECTORS } from "../src/core/constants/selectors";
import { getInputElement, setInputValue } from "../src/utils/dom";

// デバッグ用：インポートが正しく行われたかを確認
console.log('ContentScript: インポート完了', { MESSAGE_TYPES, INPUT_SELECTORS });
